...
class MinerSettings(BaseSettings):
    ...
    # GEMM tile sizes
    tile_size_m: int = 256
    tile_size_n: int = 1024
    tile_size_k: int = 256

    # fmt: off
    # Hash tile pattern for the 256x1024 tile
    ...
    384, 385, 386, 387, 392, 393, 394, 395, 400, 401, 402, 403, 408, 409, 410, 411,
    416, 417, 418, 419, 424, 425, 426, 427, 432, 433, 434, 435, 440, 441, 442, 443,
    448, 449, 450, 451, 456, 457, 458, 459, 464, 465, 466, 467, 472, 473, 474, 475,
    480, 481, 482, 483, 488, 489, 490, 491, 496, 497, 498, 499, 504, 505, 506, 507,
    ]
    # fmt: on
